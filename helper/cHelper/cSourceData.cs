    ...
    public static String GetConnStr()
    {
        ...
        try
        {
            ...
            if (servername.Contains("192.168.0") || servername.Contains("localhost"))
                tConnStr = WebConfigurationManager.ConnectionStrings["ConnectServer02"].ConnectionString;
            else
                tConnStr = WebConfigurationManager.ConnectionStrings["ConnectServerOnline"].ConnectionString;
